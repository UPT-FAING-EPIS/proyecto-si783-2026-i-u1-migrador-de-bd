...
-- Fecha: 2026-05-06 23:48:36.773299
...
CREATE TABLE IF NOT EXISTS "Inventario"."Productos" ("id" TEXT, "nombre" TEXT, "cantidad" TEXT, "precio" TEXT);
INSERT INTO "Inventario"."Productos" ("id", "nombre", "cantidad", "precio") VALUES ('1', 'Producto A', '100', '15.5');
INSERT INTO "Inventario"."Productos" ("id", "nombre", "cantidad", "precio") VALUES ('2', 'Producto B', '200', '25.75');
INSERT INTO "Inventario"."Productos" ("id", "nombre", "cantidad", "precio") VALUES ('3', 'Producto C', '150', '10.25');
INSERT INTO "Inventario"."Productos" ("id", "nombre", "cantidad", "precio") VALUES ('1', 'Producto A', '100', '15.5');
INSERT INTO "Inventario"."Productos" ("id", "nombre", "cantidad", "precio") VALUES ('2', 'Producto B', '200', '25.75');
INSERT INTO "Inventario"."Productos" ("id", "nombre", "cantidad", "precio") VALUES ('3', 'Producto C', '150', '10.25');

CREATE TABLE IF NOT EXISTS "Inventario"."MovimientosInventario" ("id" TEXT, "producto_id" TEXT, "tipo_movimiento" TEXT, "cantidad" TEXT, "fecha" TEXT);
INSERT INTO "Inventario"."MovimientosInventario" ("id", "producto_id", "tipo_movimiento", "cantidad", "fecha") VALUES ('1', '1', 'Entrada', '50', '2026-05-01');
INSERT INTO "Inventario"."MovimientosInventario" ("id", "producto_id", "tipo_movimiento", "cantidad", "fecha") VALUES ('2', '2', 'Salida', '10', '2026-05-02');
INSERT INTO "Inventario"."MovimientosInventario" ("id", "producto_id", "tipo_movimiento", "cantidad", "fecha") VALUES ('3', '3', 'Entrada', '30', '2026-05-03');
INSERT INTO "Inventario"."MovimientosInventario" ("id", "producto_id", "tipo_movimiento", "cantidad", "fecha") VALUES ('1', '1', 'Entrada', '50', '2026-05-01');
INSERT INTO "Inventario"."MovimientosInventario" ("id", "producto_id", "tipo_movimiento", "cantidad", "fecha") VALUES ('2', '2', 'Salida', '10', '2026-05-02');
INSERT INTO "Inventario"."MovimientosInventario" ("id", "producto_id", "tipo_movimiento", "cantidad", "fecha") VALUES ('3', '3', 'Entrada', '30', '2026-05-03');

CREATE TABLE IF NOT EXISTS "Ventas"."Clientes" ("id" TEXT, "nombre" TEXT, "email" TEXT);
INSERT INTO "Ventas"."Clientes" ("id", "nombre", "email") VALUES ('1', 'Juan Pérez', 'juan@example.com');
INSERT INTO "Ventas"."Clientes" ("id", "nombre", "email") VALUES ('2', 'María González', 'maria@example.com');
INSERT INTO "Ventas"."Clientes" ("id", "nombre", "email") VALUES ('1', 'Juan Pérez', 'juan@example.com');
INSERT INTO "Ventas"."Clientes" ("id", "nombre", "email") VALUES ('2', 'María González', 'maria@example.com');

CREATE TABLE IF NOT EXISTS "Ventas"."Ordenes" ("id" TEXT, "cliente_id" TEXT, "fecha" TEXT, "total" TEXT);
INSERT INTO "Ventas"."Ordenes" ("id", "cliente_id", "fecha", "total") VALUES ('1', '1', '2026-05-01', '100.0');
INSERT INTO "Ventas"."Ordenes" ("id", "cliente_id", "fecha", "total") VALUES ('2', '2', '2026-05-02', '250.5');
INSERT INTO "Ventas"."Ordenes" ("id", "cliente_id", "fecha", "total") VALUES ('1', '1', '2026-05-01', '100.0');
INSERT INTO "Ventas"."Ordenes" ("id", "cliente_id", "fecha", "total") VALUES ('2', '2', '2026-05-02', '250.5');
