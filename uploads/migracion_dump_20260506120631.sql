...
-- Fecha: 2026-05-06 12:06:31.699413
...
CREATE TABLE "Producto" ("columna_1" TEXT);

CREATE TABLE "Lote" ("columna_1" TEXT);

CREATE TABLE "Usuario" ("columna_1" TEXT);

CREATE TABLE "MovimientoInventario" ("columna_1" TEXT);

CREATE TABLE "Alertas" ("columna_1" TEXT);

CREATE TABLE "tbdetalle_venta" ("iddetalle" INTEGER, "idventa" INTEGER, "idproducto" INTEGER, "cantidad" INTEGER, "precio_unitario" REAL, "subtotal" REAL);

CREATE TABLE "tbventa" ("idventa" INTEGER, "idcliente" INTEGER, "idusuario" INTEGER, "fecha_venta" TEXT, "total" REAL, "estado" TEXT, "metodo_pago" TEXT, "observaciones" TEXT);
