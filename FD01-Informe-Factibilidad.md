...
| **Organizativo** | Cambio en el alcance o los requerimientos a mitad del desarrollo. | Media | Medio | Mantener una comunicación fluida con los stakeholders. Utilizar un plan de trabajo iterativo basado en los hitos definidos (M1 a M5). |
...
- **Plan de Desarrollo Detallado:** Para asegurar un desarrollo ordenado y medible, el proyecto se ha dividido en 5 hitos (M1 a M5) y 21 issues secuenciales, como se muestra a continuación:
